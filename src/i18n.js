const dictionary = {
  ...
  // --- Dual Testing Engine & Feedback ---
  "Test: Diagnosis": "ტესტი: დიაგნოზი",
  "Test: Pathophysiology": "ტესტი: პათოფიზიოლოგია",
  "Generate Random Patient (Diagnosis)": "შემთხვევითი პაციენტი (დიაგნოზი)",
  "Generate Random Patient (Pathophysiology)": "შემთხვევითი პაციენტი (პათოფიზიოლოგია)",
  "Confirm Pathophysiology": "პათოფიზიოლოგიის დადასტურება",
  "Your diagnosis:": "თქვენი დიაგნოზი:",
  "Correct diagnosis:": "სწორი დიაგნოზი:",
  "Your selection:": "თქვენი შერჩევა:",
  "Correct lesion(s):": "სწორი დაზიანება:",
  "Reasoning:": "ახსნა:",
  // --- Lesion Multiplier ---
  "Number of Lesions": "დაზიანებების რაოდენობა",
  "Random (Very Hard)": "შემთხვევითი (ძალიან რთული)",
  "1 Lesion (Standard)": "1 დაზიანება (სტანდარტული)",
  "2 Lesions (Hard)": "2 დაზიანება (რთული)",
  "3 Lesions (Extreme)": "3 დაზიანება (ექსტრემალური)",
  "Nothing Selected": "არაფერია არჩეული",
